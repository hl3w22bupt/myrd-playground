...
/** 塔块暖色三循环（层序读数，不表意好坏） */
export const BLOCK_CYCLE: readonly string[] = [PALETTE.BLOCK_A, PALETTE.BLOCK_B, PALETTE.BLOCK_C];
...
export function blockColor(yIndex: number): string {
...
export function layerShade(yIndex: number): number {
